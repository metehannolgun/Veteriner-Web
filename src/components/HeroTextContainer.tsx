...
const HeroTextContainer = () => {
  return (
    <div>
        ...
        Profesyonel veterinerlik hizmetlerimizle, kuşlarınızın sağlığını ve mutluluğunu ön planda tutuyoruz. 
        Sevimli dostlarınızın sağlık ihtiyaçları için profesyonel ve güvenilir hizmet.
        </p>
        {/* Butonlar için esnek konteyner , normal hali flox-col , ekran büyüdükçe row*/}
